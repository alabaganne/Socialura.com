...
wp_enqueue_style( 'blankslate-tailwind', get_template_directory_uri() . '/dist/css/app.css', array(), filemtime( get_template_directory() . '/dist/css/app.css' ) );

// Enqueue theme stylesheet (for WordPress required styles)
wp_enqueue_style( 'blankslate-style', get_stylesheet_uri() );

// Enqueue theme JavaScript
wp_enqueue_script( 'blankslate-app', get_template_directory_uri() . '/dist/js/app.js', array('jquery'), filemtime( get_template_directory() . '/dist/js/app.js' ), true );
